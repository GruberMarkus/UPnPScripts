...
'URL festlegen
'Developer Tools for UPnP Technologies von http://opentools.homeip.net/ installieren'"Device Spy.exe" starten, ein Gerät auswählen, darunter ein Service mit "Stop" finden
...
RequestHeaderSOAPAction = """urn:schemas-upnp-org:service:AVTransport:1#Stop"""
...
strXML = "<?xml version=""1.0"" encoding=""utf-8""?>" & vbcrlf & _
	...
	"	<s:Body>" & vbcrlf & _
	"		<u:Stop xmlns:u=""urn:schemas-upnp-org:service:AVTransport:1"">" & vbcrlf & _
