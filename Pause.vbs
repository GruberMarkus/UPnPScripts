...
'"Device Spy.exe" starten, ein Gerät auswählen, darunter ein Service mit "Pause" finden
...
RequestHeaderSOAPAction = """urn:schemas-upnp-org:service:AVTransport:1#Pause"""
...
strXML = "<?xml version=""1.0"" encoding=""utf-8""?>" & vbcrlf & _
	...
	"	<s:Body>" & vbcrlf & _
	"		<u:Pause xmlns:u=""urn:schemas-upnp-org:service:AVTransport:1"">" & vbcrlf & _
